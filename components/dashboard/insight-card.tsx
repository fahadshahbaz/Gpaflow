	...
	return (
		...
		>
			...
			<div className="relative z-10 flex-1">
				...
				<p className="text-sm opacity-85 leading-relaxed font-normal mb-3">
					{insight.description}
				</p>
			</div>
